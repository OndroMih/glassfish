    ...
    private static class Library {
        ...
        static {
            ...
            try {
                ...
                LOG.log(WARNING, () -> "Could not initialize sun.nio.fs, try adding '--add-opens=java.base/sun.nio.fs=ALL-UNNAMED' to JVM options. We will fallback to basic file attributes. Error: " + e.getMessage(), e);
